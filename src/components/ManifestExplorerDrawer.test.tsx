...
describe('ManifestExplorerDrawer - DrawerTabs', () => {
  ...
  it('Open a manifest with an url through the ManifestExplorerDrawer', async () => {
    ...
    // fireEvent.change(formURL, { target: { value: 'https://example.com/manifest.json' } }); //user.type génére une erreur
    await user.type(formURL, 'https://example.com/manifest.json'); //user.type génére une erreur
